...
var payload3 = '<wfs:Transaction service="WFS" version="1.0.0" xmlns:soledad="http://soledad" xmlns:ogc="http://www.opengis.net/ogc" xmlns:wfs="http://www.opengis.net/wfs"><wfs:Update typeName="soledad:predios_street_view_captura"><wfs:Property><wfs:Name>npisos</wfs:Name><wfs:Value>' + npisos +'</wfs:Value></wfs:Property><wfs:Property><wfs:Name>destino</wfs:Name><wfs:Value>' + destino +'</wfs:Value></wfs:Property><wfs:Property><wfs:Name>mutacion</wfs:Name><wfs:Value>' + mutacion +'</wfs:Value></wfs:Property><wfs:Property><wfs:Name>observacio</wfs:Name><wfs:Value>' + observaciones +'</wfs:Value></wfs:Property><wfs:Property><wfs:Name>editor</wfs:Name><wfs:Value>pruebas</wfs:Value></wfs:Property><wfs:Property><wfs:Name>hallazgos</wfs:Name><wfs:Value>capturado</wfs:Value></wfs:Property><ogc:Filter><ogc:PropertyIsEqualTo><ogc:PropertyName>codigo_ant</ogc:PropertyName><ogc:Literal>' + codigo_ant + '</ogc:Literal></ogc:PropertyIsEqualTo></ogc:Filter></wfs:Update></wfs:Transaction>';             
$.ajax(url15+'soledad/ows', {
        type: 'POST',
        dataType: 'xml',
        processData: false,
